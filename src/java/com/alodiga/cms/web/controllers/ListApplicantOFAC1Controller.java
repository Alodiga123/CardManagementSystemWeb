...
public class ListApplicantOFAC1Controller extends GenericAbstractListController<ApplicantNaturalPerson> {
    ...
    public void onClick$btnDownload() throws InterruptedException {
        try {
            Utils.exportExcel(lbxRecords, Labels.getLabel("cms.crud.applicantOFAC.list"));
        } catch (Exception ex) {
            showError(ex);
        }
    }
    ...
    public void onClick$btnReviewOFAC() {
        ...
        try {
            ...
            for (ApplicantNaturalPerson applicant: applicantList) {
                ...
                if (ofacResponse.getPercentMatch() != null) {
    ...
    public Listcell createButtonEditModal(final Object obg) {
       ...
       public void onClick$btnAdd() throws InterruptedException {
        try {
            ...
            Map<String, Object> paramsPass = new HashMap<String, Object>();
            paramsPass.put("object", applicantList);
            final Window window = (Window) Executions.createComponents(adminPage, null, paramsPass);
            window.doModal();
        } catch (Exception ex) {
