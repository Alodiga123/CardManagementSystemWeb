...
//public class ListVirtualAccountCancellationController extends GenericAbstractListController<Card> {
//
...
//    private List<Card> VirtualAccountCancellationList = null;
...
//        EventQueue que = EventQueues.lookup("updateVirtualAccountCancellation", EventQueues.APPLICATION, true);
//        que.subscribe(new EventListener() {
//            public void onEvent(Event evt) {
//                if (card != null) {
//                    getData(card.getProgramId().getId();
////                    loadList(VirtualAccountCancellationList, card);
//                }
//            }
//        });
//    }
...
//            permissionAdd = true;
//            permissionRead = true;
//            adminPage = "adminVirtualAccountCancellation.zul";
...
////        loadCmbProductType(WebConstants.EVENT_ADD, program.getId());
//    }
//     
//    public void onChange$cmbProgram() {
//        cmbProductType.setValue("");
//        program = (Program) cmbProgram.getSelectedItem().getValue();
//        Sessions.getCurrent().setAttribute(WebConstants.PROGRAM, program);
////        loadCmbProductType(WebConstants.EVENT_ADD, program.getId());
//    }
...
//        card = (Card) cmbProductType.getSelectedItem().getValue();
...
//    }
//
////    public void loadList(List<Program> list, Card card) {
////        List<Card> VirtualAccountCancellationList = new ArrayList<Card>();
////        Card Card = null;
...
////                    for (Program p : list) {
////                        p = p.getChannelId().getId().toString() + rp.getTransactionId().getId().toString() + card.getProductId().getId().toString();
...
////                            card = new Card();
////                            card.setCardId(card);
////                            card.setChannelId(rp.getChannelId());
////                            card.setFixedRate(rp.getFixedRate());
////                            card.setPercentageRate(rp.getPercentageRate());
////                            card.setRateApplicationTypeId(rp.getRateApplicationTypeId());
////                            card.setTotalInitialTransactionsExempt(rp.getTotalInitialTransactionsExempt());
////                            card.setTotalTransactionsExemptPerMonth(rp.getTotalTransactionsExemptPerMonth());
////                            card.setTransactionId(rp.getTransactionId());
////                            card.setFixedRateCR(rp.getFixedRate());
////                            card.setPercentageRateCR(rp.getPercentageRate());
////                            card.setTotalInitialTransactionsExemptCR(rp.getTotalInitialTransactionsExempt());
////                            card.setTotalTransactionsExemptPerMonthCR(rp.getTotalTransactionsExemptPerMonth());
////                            card.setCreateDate(new Timestamp(new Date().getTime()));
////                            card = cardEJB.saveRateByCard(rateByCard);
...
//        }
//    }
//    private void loadCmbProgram(Integer evenInteger, String CountryId) {
//        EJBRequest request1 = new EJBRequest();
...
//    }
//
//    private void loadCmbProductType(Integer evenInteger, String ProgramId) {
...
//        try {
//            Utils.exportExcel(lbxRecords, Labels.getLabel("cms.common.card.list"));
//        } catch (Exception ex) {
//            showError(ex);
//        }
//    }
